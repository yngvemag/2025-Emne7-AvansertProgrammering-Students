...
using StudentBloggAPI.IntegrationTests.TestData.Users;
    ...
    : IClassFixture<CustomWebApplicationFactory>
{
    ...
    [Theory]
    [MemberData(nameof(UsersControllerTestsData.GetTestUsers), MemberType = typeof(UsersControllerTestsData))]
    public async Task GetPagedUsersAsync_DefaultPageSize_ShouldReturnTwoUsers_Theory(TestUser testUser)
    {
        // Arrange
        ...
        var userDtos =
            JsonConvert.DeserializeObject<IEnumerable<UserDto>>(
                await response.Content.ReadAsStringAsync(TestContext.Current.CancellationToken));
        ...
        Assert.Collection(userDtos, dto =>
        {
